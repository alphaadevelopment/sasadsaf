...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>@lang('base.account.header')</h1></li>
            <li><small>@lang('base.account.header_sub')</small></li>
        </ul>
    </div>
</div>
<div class="col-md-6 d-none d-lg-block">
    <div class="header-liste">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('strings.account')</li>
        </ol>
    </div>
</div>
@endsection
                ...
                <div class="card">
                    ...
                    <form action="{{ route('account') }}" method="POST">
                        ...
                        <div class="card-footer with-border">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary">@lang('strings.submit')</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <form action="{{ route('account') }}" method="post">
                        ...
                        <div class="card-footer">
                            ...
                            <input type="submit" class="btn btn-primary btn-sm" value="@lang('strings.submit')" />
                        </div>
                    </form>
                </div>
            </div>
