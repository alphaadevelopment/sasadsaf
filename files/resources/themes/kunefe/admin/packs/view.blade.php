...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>{{ $pack->name }}</h1></li>
            <li><small>{{ str_limit($pack->description, 60) }}</small></li>
        </ul>
    </div>
</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="checkcard checkcard-primary no-margin-bottom">
                            <input id="pSelectable" name="selectable" type="checkcard" value="1" {{ ! $pack->selectable ?: 'checked' }}/>
                    ...
                    <div class="form-group">
                        <div class="checkcard checkcard-primary no-margin-bottom">
                            <input id="pVisible" name="visible" type="checkcard" value="1" {{ ! $pack->visible ?: 'checked' }}/>
                            <label for="pVisible">
                                Visible
                            </label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="checkcard checkcard-warning no-margin-bottom">
                            <input id="pLocked" name="locked" type="checkcard" value="1" {{ ! $pack->locked ?: 'checked' }}/>
                            <label for="pLocked">
                                Locked
                            </label>
                        </div>
