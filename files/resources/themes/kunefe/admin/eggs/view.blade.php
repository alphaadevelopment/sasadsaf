...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            ...
            <li><small>{{ str_limit($egg->description, 50) }}</small></li>
        </ul>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="alert alert-info">
            <strong>Uyarı:</strong> Editing an Egg or any of the Process Management fields <em>requires</em> that each Daemon be rebooted in order to apply the changes.
        </div>
    </div>
</div>
