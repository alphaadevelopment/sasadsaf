...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>Database Hosts</h1></li>
            <li><small>Database hosts that servers can have databases created on.</small></li>
        </ul>
    </div>
</div>
<div class="col-md-6 d-none d-lg-block">
    <div class="header-liste">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Database Hosts</li>
        </ol>
    </div>
</div>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newHostModal">Create New</a>
                        </div>
                    </div>
                </div>
            </div>
