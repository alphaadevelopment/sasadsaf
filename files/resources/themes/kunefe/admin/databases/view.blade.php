...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>Database - {{ $host->name }}</h1></li>
            <li><small>Viewing associated databases and details for this database host.</small></li>
        </ul>
    </div>
</div>
<div class="col-md-6 d-none d-lg-block">
    <div class="header-liste">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Database Hosts</li>
