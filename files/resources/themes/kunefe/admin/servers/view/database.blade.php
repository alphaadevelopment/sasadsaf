...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            ...
            <li><small>Manage server databases.</small></li>
        </ul>
    </div>
</div>
                    ...
                    @foreach($server->databases as $database)
                        <tr>
                            ...
                            <td class="text-center">
                                <button data-action="reset-password" data-id="{{ $database->id }}" class="btn btn-sm btn-primary"><i class="fa fa-sync-alt"></i></button>
    ...
    $('[data-action="reset-password"]').click(function (e) {
        ...
        $.ajax({
            ...
            Swal.fire({
                icon: 'success',
                title: '',
                icon: 'The password for this database has been reset.',
            });
