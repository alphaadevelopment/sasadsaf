...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            ...
            <li><small>Edit details for this server including owner and container.</small></li>
        </ul>
    </div>
</div>
    ...
    $('#pUserId').select2({
        ...
        templateResult: function (data) {
            ...
            return '<div class="user-block"> \
                <img class="img-circle img-bordered-xs" width="25" src="https://www.gravatar.com/avatar/' + data.md5 + '?s=120" alt="User Image"> \
                <span class="username"> \
        ...
        templateSelection: function (data) {
            ...
            return '<div> \
                <span> \
                    <img class="img-rounded img-bordered-xs" width="25" src="https://www.gravatar.com/avatar/' + data.md5 + '?s=120" style="height:28px;margin-top:-4px;" alt="User Image"> \
                </span> \
