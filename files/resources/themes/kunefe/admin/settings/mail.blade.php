...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>Mail Settings</h1></li>
            <li><small>Edit the settings of the mail sending process.</small></li>
        </ul>
    </div>
</div>
    ...
    <script>
        ...
        function testSettings() {
            Swal.fire({
                ...
                html: 'Click "Test" to begin the test.',
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        Swal.fire({
                            title: 'Success',
                            html: 'The test message was sent successfully.',
                            icon: 'success'
                        });
                    });
                }
        ...
        function showErrorDialog(jqXHR, verb) {
            ...
            Swal.fire({
                title: 'Whoops!',
                html: 'An error occurred while attempting to ' + verb + ' mail settings: ' + errorText,
                icon: 'error'
            });
        }
        ...
        $(document).ready(function () {
            ...
            $('#saveButton').on('click', function () {
                saveSettings().done(function () {
                    Swal.fire({
                        title: 'Success',
                        html: 'Mail settings have been updated successfully and the queue worker was restarted to apply these changes.',
                        icon: 'success'
                    });
                });
            });
