...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>Panel Settings</h1></li>
            <li><small>Edit panel settings.</small></li>
        </ul>
    </div>
</div>
            ...
            <div class="card">
                ...
                <form action="{{ route('admin.settings') }}" method="POST">
                    ...
                    <div class="card-footer">
                        {!! csrf_field() !!}
                        <button type="submit" name="_method" value="PATCH" class="btn btn-sm btn-primary pull-right">Submit</button>
                    </div>
                </form>
            </div>
        </div>
