...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>Advanced Settings</h1></li>
            <li><small>Edit advanced settings.</small></li>
        </ul>
    </div>
</div>
        ...
        <div class="col-md-12">
            <form action="" method="POST">
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        {{ csrf_field() }}
                        <button type="submit" name="_method" value="PATCH" class="btn btn-md btn-primary float-right">Submit</button>
                    </div>
                </div>
            </form>
        </div>
