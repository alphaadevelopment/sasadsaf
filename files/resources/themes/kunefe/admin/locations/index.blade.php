...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            ...
            <li><small>All locations that nodes can be assigned to for easier categorization.</small></li>
        </ul>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newLocationModal">Create New</a>
                        </div>
                    </div>
                </div>
            </div>
