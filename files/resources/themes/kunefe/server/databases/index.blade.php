                        ...
                        <tbody>
                            ...
                            @foreach($databases as $database)
                                <tr>
                                    ...
                                    <td class="middle">
                                        <code class="toggle-display" style="cursor:pointer" data-toggle="tooltip" data-placement="right" title="Görmek için tıklayın">
                    ...
                    <form action="{{ route('server.databases.new', $server->uuidShort) }}" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input id="pDatabaseName" type="text" name="database" class="form-control" placeholder="veritabanı adı" />
                            </div>
