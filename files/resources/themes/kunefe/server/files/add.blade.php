...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>@lang('server.files.add.header')</h1></li>
            <li><small>@lang('server.files.add.header_sub')</small></li>
        </ul>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-header with-border">
                <div class="input-group">
                    <span class="filemg-input"><code>/home/container/</code></span>
            ...
            <div class="card-footer with-border">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <a href="{{ route('server.files.index', [ 'server' => $server->uuidShort, 'dir' => $directory ]) }}"><button class="btn btn-default btn-md">@lang('strings.cancel')</button></a>
                    </div>
                    <div class="col-sm-4">
