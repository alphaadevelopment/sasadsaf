...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>@lang('server.schedule.new.header')</h1></li>
            <li><small>@lang('server.schedule.new.header_sub')</small></li>
        </ul>
    </div>
</div>
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn btn-md btn-primary" data-action="add-new-task"><i class="fa fa-plus"></i> @lang('server.schedule.task.add_more')</button>
