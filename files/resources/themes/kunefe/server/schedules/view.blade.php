...
<div class="col-sm-12 col-md-6">
    <div class="header-bilgi">
        ...
        <ul class="list list-unstyled">
            <li><h1>@lang('server.schedule.manage.header')</h1></li>
            <li><small>@lang('server.schedule.manage.submit')</small></li>
        </ul>
    </div>
</div>
            ...
            <div class="card card-primary">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" id="containsTaskList">
                            @include('partials.schedules.task-template')
                            <div id="taskAppendBefore"></div>
                        </div>
                    </div>
                </div>
                <div class="card-footer" >
                    ...
                    <div class="float-left">
                        {!! csrf_field() !!}
                        <button type="button" class="btn btn-md btn-default" data-action="add-new-task"><i class="fa fa-plus"></i> @lang('server.schedule.task.add_more')</button>
                        <button type="submit" class="btn btn-md btn-success" name="_method" value="PATCH">@lang('server.schedule.manage.submit')</button>
                    </div>
                    <div class="float-right">
                        <button type="submit" class="btn btn-md btn-danger muted muted-hover" id="deleteButton" name="_method" value="DELETE"><i class="fa fa-trash"></i></button>
                    </div>
                </div>
            </div>
        </div>
